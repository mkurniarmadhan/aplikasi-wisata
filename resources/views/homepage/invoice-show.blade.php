            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="checkout__order">
                        ...
                        @if (!$order->buktiBayar)
                            <form action="{{ route('homepahe.uploadBuktiBayar', $order) }}" method="POST"
                            ...
                            <div class="conf">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <span class="top__text">
                                                ...
                                                @if (!$order->buktiBayar)
                                                    Silahkan melakukan pembayran pada rekening yang tertera dibawah
                                                    (Setelah Transfer
                                                ...
                                                @else
                                                    @if (!$order->statusBayar)
                                                        ...
                                                        <a
                                                            href="https://api.whatsapp.com/send/?phone=6287829234934&text=hallo%20Admin%0AKONFIRMASI%20PEMESANAN%0A%0ANO%20PEMESANAN%0A{{ $order->id }}%0A%0A">KONFRIMAS
                                                            KE ADMIN</a>
                                                    @endif
                                ...
                                @if (!$order->buktiBayar)
                                    <div class="checkout__order__product">
                                        <ul>
                                            <li>
                                                <span class="top__text">BCA
                                                    <br>
                                                    AMAR NO RENING 2710375576
                                                </span>
                                            </li>
